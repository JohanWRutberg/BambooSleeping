...
export default function CategoryPage({ initialData, category }) {
  ...
  return (
    <>
      <Head>
        <title>{category ? `${category} | Bamboo Sleeping` : "Bamboo Sleeping"}</title>
        <meta name="keywords" content={category || "Topic on Bamboo Sleeping"} />
        <meta property="og:title" content={category || "Topic on Bamboo Sleeping"} />
        <meta
        ...
        <meta name="twitter:title" content={category || "Topic on Bamboo Sleeping"} />
        <meta
