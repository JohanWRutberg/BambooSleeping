...
export default function CategoryPage({ initialData, tag }) {
  ...
  return (
    <>
      <Head>
        <title>{tag ? `${tag} | Bamboo Sleeping` : "Bamboo Sleeping"}</title>
        <meta name="keywords" content={tag || "Tags on Bamboo Sleeping"} />
        <meta property="og:title" content={tag || "Tags on Bamboo Sleeping"} />
        <meta
        ...
        <meta name="twitter:title" content={tag || "Tags on Bamboo Sleeping"} />
        <meta
                      ...
                      <div className="bloginfo mt-2">
                        ...
                        <div className="blogauthor flex gap-1">
                          <div className="blogaimg">
                            <Image src="/img/BambooSleeping.png" width={50} height={50} />
                          </div>
